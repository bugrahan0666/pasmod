...
module.exports.run = async (client, message, args, params) => {
    ...
    let embed = new Discord.MessageEmbed().setColor("RANDOM").setFooter("Aias was here!", message.author.avatarURL({dynamic: true})).setTimestamp().setAuthor(message.guild.name, message.guild.iconURL({dynamic: true}))
