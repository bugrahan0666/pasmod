...
module.exports.run = async (client, message, args) => {
   ...
   client.channels.cache.get(ayar.jailLog).send(new Discord.MessageEmbed().setAuthor(`❤️ Aias `, message.author.avatarURL()).setColor("BLACK").setDescription(`${member} Adlı Üye Jailden Çıkarıldı\nJailden Çıkaran Yetkili ${message.author}`));
}
